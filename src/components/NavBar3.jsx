...
const Navbar3 = () => {
    ...
    return (
        <div>
            <div className="navbar josefin  bg-opacity-20 !z-99999 !overflow-visible">
                <div className="navbar-start">
                    <div className="dropdown !z-9999">
                        ...
                        <ul
                            tabIndex={0}
                            className="menu menu-sm dropdown-content mt-3 !z-9999999 p-2 shadow bg-base-100 rounded-box w-52 px-5 space-x-2 text-lg !overflow-visible"
                        >
                            {Navlinks}
                        </ul>
                    </div>
                ...
                <div className="navbar-end  justify-end gap-2 ">
                    ...
                    <div
                        tabIndex="0"
                        className="collapse collapse-open  !overflow-visible flex justify-end"
                    >
                        <div className="collapse-content">
                            <div
                                tabIndex={0}
                                role="button"
                                className="btn btn-ghost btn-circle avatar dropdown"
                            >
